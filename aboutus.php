...
:30%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px #fc7af7;border-radius:10px;padding:3%;font-size:15px;height:200px;"><marquee direction="up" scrolldelay="200" >
         ...
         <tr><td><br/></td><td>1. Abhirashmi Kumari  </td><td><br/></td><td> Role = ( UI  Developer + Backend Developer )
         <br>Mail-ID : abhirashmi2000@gmail.com</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
         <tr><td><br/></td><td>2. Nitiksha</td><td><br/></td><td>Role  = ( UI  Developer  )<br>Mail-ID : </td><td><br/></td></tr>
        ...
        <div  style="background-color:orange; border:solid 2px orange;border-radius: 10px; width:84%; height:40px; margin-left:10%; margin-top:15px" >
          <marquee behavior="alternate" direction="right" loop="1" style="margin-right:38%" align="center"><h3 style="line-height:1px;">Thank You For Using This System.</h6></marquee>
